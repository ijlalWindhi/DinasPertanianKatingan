  ...
  return (
    <Box minH={"100vh"}>
      ...
      <Box px={28} py={5} bgColor={"primary.500"}>
        <Heading>Daftar Harga Komoditi Dinas Pertanian Kab. Katingan</Heading>
          ...
          <Box display={"flex"} alignItems={"center"} gap={10}>
            <Box display={"flex"} alignItems={"center"}>
              ...
              <Menu>
                ...
                <MenuList>
                  <MenuItem onClick={() => setSelectedKomoditi("Semua")}>
                    Semua Komoditi
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedKomoditi("Kelapa Sawit")}>
                    Kelapa Sawit
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedKomoditi("Kelapa")}>
                    Kelapa
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedKomoditi("Kopi")}>
                    Kopi
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedKomoditi("Karet")}>
                    Karet
                  </MenuItem>
                </MenuList>
              </Menu>
            ...
            <Box display={"flex"} alignItems={"center"}>
              ...
              <Menu>
                ...
                <MenuList>
                  <MenuItem onClick={() => setSelectedTahun("Semua")}>
                    Semua Tahun
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedTahun("2014")}>
                    2014
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedTahun("2015")}>
                    2015
                  </MenuItem>
                  <MenuItem onClick={() => setSelectedTahun("2016")}>
                    2016
                  </MenuItem>
                </MenuList>
              </Menu>
